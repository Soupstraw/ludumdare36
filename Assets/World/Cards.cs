...
namespace Game
{
    ...
    public class Ageing: Card
    {
        ...
        public override Options options (State state)
        {
            ...
            options.yes.resolve = delegate() {d 
    ...
    public static class Fork
    {
        public static string[] Sign = new string[] {
            "You notice a worn out post barely holding two signs.",
        ...
        public static string[] TownWalk = new string[] {
            ...
            "You take your first steps and wonder what will lay ahead.",
        };
    ...
    public class Sheep: Card
    {
        ...
        public override string[] describe (State state)
        {
            return new string[] {
                ...
                "He seems to have an intergalactic quality."
            };
        }
        ...
        public override Options options (State state)
        {
            ...
            options.yes.resolve = delegate() {
                return new string[] {
                    "You poke the sheep. He pops out of existence. Maybe it is better this way?",
    ...
    public class Archeologist: Card
    {
        ...
        public override Options options (State state)
        {
            ...
            if (state.player.depression) {
                ...
                options.no.resolve = delegate() {
                    return new string[] {
                        "You take offense at what the man said and simply leave. You have a reason to live already!"
                    };
                };
            } else {
    ...
    public class BrokenClockwork: Card
    {
        ...
        public override string[] describe (State state)
        {
            return new string[] {
                ...
                "You slowly approach it, it seems that debris from the ceiling has damaged the device and broken off some pieces.",
            };
        }
            ...
            if (state.player.stickyBoots) {
                options.yes.resolve = delegate() {
                    ...
                    return new string[] {
                        ...
                        "A slight glow starts to emanate from the device."
                    };
                };
            } else {
                options.yes.resolve = delegate() {
                    return new string[] {
                        ...
                        "You walk away wondering where to get glue on your boots."
                    };
                };
            }
            ...
            if (state.player.peaceOfMind) {
                options.yes.resolve = delegate() {
                    ...
                    return new string[] {
                        ...
                        "It makes little sense to you but you feel like this information is going to be useful someday. She sends you off.",
        ...
        public override Options options (State state)
        {
            ...
            if (state.player.oldAge) {
                ...
                options.no.resolve = delegate() {
                    ...
                    state.die ();
                    return new string[] {
                        "Death comes toward you. The world begins to swirl..You feel a deep feeling of disgust. Was it your emotion or not, you don’t know. But does it matter?"
                    };
                };
            } else {
                options.yes.resolve = delegate() {
                    ...
                    return new string[] {
                        ...
                        state.player.depression ? "You wish he had taken you. He brought comfort to your misery." : ""
                    };
                };
                ...
                options.no.resolve = delegate() {
                    state.player.seenDeath = true;
                    return new string[] {
                        "Death comes toward you. The world begins to swirl and then stops. You feel a deep feeling of disgust. Was it your emotion or not, you don’t know. But does it matter?",
                        "You think \"It’s not your time\" and then realize that it wasn’t your thought. ",
